...
export function PostCard({ post }: PostCardProps) {
  ...
  return (
    <Card className={`overflow-visible ${post.author.role === "Supreme Leader" ? "bg-yellow-100" : post.author.role === "The Council of Snow" ? "bg-blue-100" : post.author.role === "The Great Hall of the North" ? "bg-blue-200" : ""}`} data-testid={`card-post-${post.id}`}>
